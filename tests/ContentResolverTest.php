...
final class ContentResolverTest extends TestCase
{
    ...
    #[TestDox('Preserves a Storyblok field that the Croct content omits because it is optional.')]
    public function testPreservesOptionalFieldOmittedByCroct(): void
    {
        $fetcher = static fn (string $id): FetchResponse => self::createResponse(
            [
        ...
        $content = [
            ...
            'cta' => [
                [
                    ...
                    'link' => self::createMultilink('catalog/'),
                    'label' => 'Shop now',
                    'component' => 'cta',
                ],
            ],
            'image' => self::createAsset('https://a.storyblok.com/f/289964601464397/4240x2827/788dbcaf4d/fallback.png'),
            ...
            [
                ...
                'cta' => [
                    [
                        '_uid' => self::RANDOM_UUID,
                        'component' => 'cta',
                        'link' => self::createMultilink('https://storyblok-next-personalization.vercel.app/catalog'),
                        'label' => 'Some CTA label',
                    ],
                ],
                'image' => self::createAsset(
                    'https://a.storyblok.com/f/289964601464397/4240x2827/788dbcaf4d/fallback.png',
                ),
                'tagline' => 'Sporty or elegant, we got you covered.',
                'headline' => 'Some heading',
            ],
    ...
    #[TestDox('Drops an optional field that neither Croct nor Storyblok provides.')]
    public function testDropsOptionalFieldMissingFromBoth(): void
    {
        $fetcher = static fn (string $id): FetchResponse => self::createResponse(
            [
                '_component' => 'hero',
    ...
    #[TestDox('Does not recover fallback fields when the schema root is not a structure.')]
    public function testDoesNotRecoverFieldsForNonStructureRoot(): void
    {
        $fetcher = static fn (string $id): FetchResponse => self::createResponse(
            [
                'title' => 'Fetched Title',
    ...
    #[TestDox('Falls back to the marker content when the fetched content does not match the schema.')]
    public function testFallsBackWhenContentDoesNotMatchSchema(): void
    {
        $fetcher = static fn (string $id): FetchResponse => self::createResponse(
            [
                '_component' => 'hero',
            ...
            self::createStructureSchema('headline', [
                'type' => 'text',
            ]),
        );
